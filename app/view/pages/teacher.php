...
<body>
    ...
    <!-- add button and form -->
    <button type="button" class="btn btn-primary m-3" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@getbootstrap">Add Teacher</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?php echo URLROOT; ?>/TeacherController/insertTeacher" method="post">
                        ...
                        <button type="submit" value="submit" name="submit" style="margin-top: 20px;" class="btn btn-outline-warning btn-rounded" data-mdb-ripple-color="dark">submit</button>
